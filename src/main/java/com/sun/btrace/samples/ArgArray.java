...
/**
 * This sample demonstrates regular expression probe matching and getting input
 * arguments as an array - so that any overload variant can be traced in
 * "one place". This example traces any "readXX" method on any class in java.io
