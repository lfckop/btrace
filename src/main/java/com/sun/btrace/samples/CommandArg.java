...
/**
 * This BTrace program demonstrates command line arguments. $ method helps in
 * getting command line arguments. In this example, desired thread name is
 * passed from the command line (of the BTrace client).
 */
@BTrace
public class CommandArg {
    @OnMethod(clazz = "java.lang.Thread", method = "run")
