...
/**
 * This sample collects histogram of javax.swing.JComponets created by traced
 * app. The histogram is printed once every 4 seconds. Also, this example
 * exposes the trace class as a JMX bean. After connecting BTrace to the target
 * application, connect VisualVM or jconsole or any other JMX client to the same
 * application.
 */
@BTrace
