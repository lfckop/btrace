...
/**
 * This program demonstrates OnExit probe. When some BTrace action method calls
 * "exit(int)" built-in function, method annotated by @OnExit (if found) is
 * called. In this method, BTrace script print summary information of tracing
 * and/or do clean-up.
 */
