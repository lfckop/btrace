...
/**
 * Simple log message tracer class. This class prints all log messages
 * regardless of log Level. Note that we read LogRecord's private "message"
 * field using "field()" and "objectValue()" built-ins.
 */
@BTrace
public class LogTracer {
    private static Field msgField = Reflective.field(
            "java.util.logging.LogRecord", "message");
