 ...
 * Unlike SockerTracker.java, this script uses only public API classes and @OnProbe
 * probes - which would be mapped to internal implementation classes by a XML
 * descriptor at BTrace agent. For this sample, XML probe descriptor is
 * "java.net.socket.xml".
 */
@BTrace
public class SocketTracker1 {
    ...
    @OnProbe(namespace = "java.net.socket", name = "server-socket-creator")
    ...
    @OnProbe(namespace = "java.net.socket", name = "bind-return")
    ...
    @OnProbe(namespace = "java.net.socket", name = "accept-return")
