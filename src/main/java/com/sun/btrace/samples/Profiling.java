 ...
 * definition one can safely omit all other modifiers when declaring methods and
 * variables</li>
 * <li>Extended syntax for <b>@ProbeMethodName</b> annotation - you can use
 * <b>fqn</b> parameter to request a fully qualified method name instead of the
 * short one</li>
...
class Profiling {
    ...
    @OnTimer(5000)
    void timer() {
        BTraceUtils.Profiling.printSnapshot("Swing performance profile",
                swingProfiler);
    }
}
